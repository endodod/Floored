...
>(({ className, children, hideClose, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    {/* Centered via flexbox rather than the classic left-50%+translate-50% trick —
        Tailwind 3.4 emits translate utilities as a standalone CSS `translate` property
        that stacks with tailwindcss-animate's transform-based enter/exit keyframes,
        doubling the offset and shoving the dialog off-center. */}
